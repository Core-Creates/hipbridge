...
```
PASS  rms_norm_affine vs hipbridge.kernels.norm.rms_norm_affine (Triton, AMD-tuned), eps=1e-05: 31/31 cases, worst ulp=12 (max abs 2.441e-04)  [accuracy vs original: equivalent=31]
```
