...
```
PASS  rms_norm_affine vs hipbridge.kernels.norm.rms_norm_affine (Triton, AMD-tuned), eps=1e-05: 31/31 cases, worst ulp=61 (max abs 1.404e-03)  [accuracy vs original: better=4, equivalent=27, up to 43x closer to float64]
```
