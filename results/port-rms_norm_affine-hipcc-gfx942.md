...
```
PASS  rms_norm_affine vs hipbridge.kernels.norm.rms_norm_affine (Triton, AMD-tuned): 28/28 cases, worst ulp=2 (max abs 1.526e-05)  [accuracy vs original: equivalent=28]
```
