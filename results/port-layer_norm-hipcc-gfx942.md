...
```
PASS  layer_norm vs hipbridge.kernels.norm.layer_norm (Triton, AMD-tuned), eps=1e-05: 31/31 cases, worst ulp=1751849056 (max abs 1.314e-04)  [accuracy vs original: better=8, equivalent=23, up to 695x closer to float64]
```
