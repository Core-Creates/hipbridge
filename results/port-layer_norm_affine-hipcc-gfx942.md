...
```
PASS  layer_norm_affine vs hipbridge.kernels.norm.layer_norm_affine (Triton, AMD-tuned), eps=1e-05: 31/31 cases, worst ulp=6567080 (max abs 1.099e-03)  [accuracy vs original: better=7, equivalent=24, up to 427x closer to float64]
```
