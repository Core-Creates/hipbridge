...
| field | value |
|---|---|
| generated | 2026-09-07 23:35 UTC |
...
```
PASS  rms_norm_affine vs original on hipcc: 126/126 cases, worst ulp=3 (max abs 3.052e-05)  [accuracy vs original: equivalent=126, up to 3x closer to float64]
```
